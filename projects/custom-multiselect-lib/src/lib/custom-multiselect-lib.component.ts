...
export const MULTISELECT_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => CustomMultiselectLibComponent),
  multi: true
};
...
@Component({
  ...
  `,
  styleUrls: ['./custom-multiselect-lib.css'],
  animations: [
...
export class CustomMultiselectLibComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy, ControlValueAccessor {
...
@NgModule({
  ...
  exports: [CustomMultiselectLibComponent, SharedModule],
